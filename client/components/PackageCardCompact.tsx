        ...
        <div className="p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link
              ...
              className="block text-center whitespace-nowrap px-2 py-3 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wide transition-colors border-2 border-gray-700 text-gray-700 hover:border-primary hover:bg-primary hover:text-white active:border-primary-dark active:bg-primary-dark active:text-white"
            >
              Book Now
            </Link>
            ...
            <button
              ...
              className="block text-center whitespace-nowrap px-2 py-3 rounded-full text-xs sm:text-sm font-bold uppercase tracking-wide transition-colors border-2 border-gray-700 text-gray-700 hover:border-primary hover:bg-primary hover:text-white active:border-primary-dark active:bg-primary-dark active:text-white cursor-pointer"
            >
              Collection
            </button>
          </div>
