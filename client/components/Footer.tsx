          ...
          <div>
            ...
            <ul className="space-y-3.5">
              ...
              <li className="flex gap-3">
                ...
                <a href="tel:+94713207241" className="text-sm hover:text-white transition-colors duration-200 cursor-pointer">
                  +94 71 320 7241
                </a>
              </li>
              <li className="flex gap-3">
                ...
                <a href="https://wa.me/94713207241" target="_blank" rel="noopener noreferrer" className="text-sm hover:text-white transition-colors duration-200 cursor-pointer">
                  WhatsApp Us
                </a>
              </li>
              <li className="flex gap-3">
