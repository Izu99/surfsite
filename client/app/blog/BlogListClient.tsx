            ...
            >
              <div className="grid md:grid-cols-2">
                <div className="relative h-64 md:h-auto overflow-hidden">
                  ...
                  />
                  <span className="absolute top-4 left-4 bg-primary text-white text-xs font-bold px-3 py-1 flex items-center gap-1">
                ...
                {paginated.map((post) => (
                  ...
                  >
                    <div className="relative h-52 overflow-hidden">
                      ...
                      />
                      <span className="absolute top-3 left-3 bg-white/90 text-primary text-xs font-bold px-2.5 py-1 rounded-full">
                        {post.category}
                      </span>
                    </div>
                    <div className="p-5">
                      <h3 className="font-bold text-gray-900 text-base mb-2 leading-snug group-hover:text-primary transition-colors line-clamp-2">
                        {post.title}
                      </h3>
