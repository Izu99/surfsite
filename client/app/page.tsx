...
import { Play, Star, Facebook, Twitter, Linkedin } from 'lucide-react'
import HeroSlideshow from '@/components/HeroSlideshow'
import ServicesSlider from '@/components/ServicesSlider'
import HomepagePackages from '@/components/HomepagePackages'

export const metadata: Metadata = {
  title: { absolute: 'Noah Surf School | Surf Lessons at Hirikatiya Beach, Sri Lanka' },
  description:
    'Learn to surf at Hirikatiya Beach, Sri Lanka with Noah Surf School. ILS-certified instructors, group lessons, private coaching, board rentals, and multi-day surf camps.',
  openGraph: {
    title: 'Noah Surf School | Surf Lessons at Hirikatiya Beach, Sri Lanka',
    description:
      'ILS-certified surf instructors, group lessons, private coaching, board rentals, and surf camps at Hirikatiya Beach, Sri Lanka.',
  },
}
